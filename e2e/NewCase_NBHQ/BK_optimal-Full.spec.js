...
if (!claimed) {
  ...
  continue;
    ...
    try {
      ...
      const tempNo = String(tempReceiptNo || '').trim();
...
// =============
  ...
  //  await mandatoryFillTab(page,'ออโตเมทดาต้า', page.getByRole('textbox', { name: 'สาขา *' }),'สาขาธนาคาร');
  ...
  // await mandatoryFillTab(page,'ออโตเมทดาต้า', page.getByRole('textbox', { name: 'สาขา *' }),'สาขาธนาคาร');
    ...
    //A18 พัง
    //await page.getByRole('textbox', { name: 'จำนวนเงิน *' }).fill(insuredAmount);
    // await page.waitForTimeout(1000);
    // await page.getByRole('textbox', { name: 'จำนวนเงิน *' }).fill((filledPay ?? 0).toString());
//     await page.locator('#amount4').fill(
//   (
//     await page
...
for (let i = 0; i < numBeneInt; i++) {
  ...
  if (i === numBeneInt - 1) {
    ...
    // await page.getByRole('textbox', { name: /ส่วนสูง/ }).click();
    // await page.getByRole('textbox', { name: /ส่วนสูง/ }).fill(height);
...
//     await fillAndVerify(page.locator('#bmiWeight'), weight, {
//   label: 'น้ำหนัก',
//   matchMode: 'includes',
// });
await mandatoryFill(page, weight, '#bmiWeight', 'น้ำหนัก');
  ...
  await page.getByRole('button', { name: 'ยืนยัน' }).click();
    ...
    //ระบุตัวแทนในรับฝาก เก่า
    // await page.getByText('ตัวแทน').first().click();
    // await page.waitForTimeout(200);
    // await page.getByRole('textbox', { name: 'กรุณาระบุ' }).first().click();
    // await page.getByRole('textbox', { name: 'กรุณาระบุ' }).first().fill(cusName); //กรอกชื่อ
    // await page.getByRole('textbox', { name: 'กรุณาระบุ' }).nth(1).click();
    // await page.waitForTimeout(200);
    // await page.getByRole('textbox', { name: 'กรุณาระบุ' }).nth(1).fill(cusSurname); //กรอกนามสกุล
    // await page.waitForTimeout(200);
...
await page.waitForTimeout(200);
    ...
    //await page.waitForTimeout(1000);    
    //await page.locator('.MuiInputBase-root.MuiInput-root.MuiInput-underline.MuiInputBase-fullWidth.MuiInput-fullWidth.Mui-focused > .MuiInputBase-input').fill(insuredAmount); //ค่าเบี้ยที่ไปดึงมาจากหน้าก่อน
    //await page.waitForTimeout(1000);    
    await page.locator('.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-1 > div:nth-child(3) > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-input').click();
  ...
  await page.locator('.MuiInputBase-root.MuiInput-root.MuiInput-underline.MuiInputBase-fullWidth.MuiInput-fullWidth.Mui-focused > .MuiInputBase-input').fill(totalAmount);
    //   await page
  // .locator('.MuiInputBase-root.MuiInput-root.MuiInput-underline.MuiInputBase-fullWidth.MuiInput-fullWidth.Mui-focused > .MuiInputBase-input')
  // .fill(
  //   (
  //     Number(
  //       (
  ...
  // );
    ...
    //A18 พัง
    // await page.locator('.MuiInputBase-root.MuiInput-root.MuiInput-underline.MuiInputBase-fullWidth.MuiInput-fullWidth.Mui-focused > .MuiInputBase-input').fill(insuredAmount); //ใส่จนเงิน  premiumAll
    ...
    //A18 พัง
    // await page.locator('.MuiInputBase-root.MuiInput-root.MuiInput-underline.MuiInputBase-fullWidth.MuiInput-fullWidth.Mui-focused > .MuiInputBase-input').fill(insuredAmount);
    // await page.locator('.MuiInputBase-root.MuiInput-root.MuiInput-underline.MuiInputBase-fullWidth.MuiInput-fullWidth.Mui-focused > .MuiInputBase-input').press('Tab');
    // await page.waitForTimeout(1000);

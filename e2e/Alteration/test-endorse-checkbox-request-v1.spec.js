...
const { datadict_endorse_checkbox } = require('../../data/Alteration/old version/inquiryform_datadict_endorse_checkbox.data.js');
const { datadict_endorse_checkbox_sub_status } = require('../../data/Alteration/inquiryform_datadict_endorse_checkbox_2_Sub_Status_v1.data.js');
const { raw_data_alteration } = require('../../data/Alteration/old version/raw_data_alteration.data.js');
const { data_matrix_endorse } = require('../../data/Alteration/data_endorse_checkbox_v1.data.js');
...
const startIdx = 0;
const endIdx = 1000; //ท็อปใช้ 478 -10000 
...
for (const data_endorse of testData) {
    ...
    test(`Scenario | ${data_endorse.channel_code}_${data_endorse.policy_type}_${data_endorse.policy_line}_${data_endorse.policy_status}_${data_endorse.contact_code}`, async ({ page }, testInfo) => {
        ...
        const range_write = `upload-to-sheet_Playwright!A:Z`;
        // เริ่มต้น Auth

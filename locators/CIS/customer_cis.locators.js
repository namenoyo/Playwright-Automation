...
export const detailcustomerCISLocatorsArraykey = (page) => ({
    ...
    SELECTOR_CIS_MENU_SUB_1_SEARCH_1_Detail_1_panel_4_In_Page_9_Data_Grid: page.locator('tbody.MuiTableBody-root').nth(3).locator('tr'),
    SELECTOR_CIS_MENU_SUB_1_SEARCH_1_Detail_1_panel_5_In_Page_14_Data_Grid: page.locator('tbody.MuiTableBody-root').nth(4).locator('tr'),
    SELECTOR_CIS_MENU_SUB_1_SEARCH_1_Detail_1_panel_6_In_Page_20_Data_Grid: page.locator('tbody.MuiTableBody-root').nth(5).locator('tr'),
    SELECTOR_CIS_MENU_SUB_1_SEARCH_1_Detail_1_panel_7_In_Page_13_Data_Grid: page.locator('tbody.MuiTableBody-root').nth(6).locator('tr'),
